...
// const letsCookButton = document.getElementById('letsCookButton')
...
//   show([recipeInfoView, seeAllRecipesButton, homeButton, favoriteRecipesButton, searchButton, dropDownButton, userShoppingView]);
...
// letsCookButton.addEventListener('click', postApi)